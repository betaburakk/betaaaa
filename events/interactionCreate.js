...
module.exports = (client, int) => {
    ...
    switch (int.customId) {
        case 'saveTrack': {
          ...
          .setTimestamp()
          .setFooter({ text: 'Music Bot Commands - by BETA ❤️', iconURL: int.user.displayAvatarURL({ dynamic: true }) });
        ...
        case 'time': {
            ...
            .setFooter({ text: 'Muzik Bot için Komutlar ❤️', iconURL: int.user.displayAvatarURL({ dynamic: true }) });
